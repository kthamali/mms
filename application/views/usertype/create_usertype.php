<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Create New User Type <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('userTypeDescription', set_value('usertypedescription') , array('class' => 'form-control', 'placeholder' => 'User Type', 'id' => 'usertypedescription')); ?>
