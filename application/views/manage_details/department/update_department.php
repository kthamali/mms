<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Update Department <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('departmentName', set_value('departmentname',$department_details->departmentName) , array('class' => 'form-control', 'placeholder' => 'Department Name', 'id' => 'departmentname')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('departmentCode', set_value('departmentcode',$department_details->departmentCode) , array('class' => 'form-control', 'placeholder' => 'Department Code', 'id' => 'departmentcode')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('offerModules', set_value('offermodules',$department_details->offerModules) , array('class' => 'form-control', 'placeholder' => 'Offer Modules', 'id' => 'offermodules')); ?>
			<div class="text-error"><?php echo form_error('offerModules'); ?></div>
		</div>

		<div class="form-group">
			<label for="facultyId">Faculty <span class="text-red">*</span></label>
			<?php echo form_dropdown('facultyId', $faculty_dropdown, set_value('facultyId', $department_details->faculty_id), array('class'=> 'form-control')); ?>
