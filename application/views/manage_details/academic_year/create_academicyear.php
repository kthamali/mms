<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Create New Academic Year <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('academicYearDescription', set_value('academicyeardescription') , array('class' => 'form-control', 'placeholder' => 'Academic Year Description', 'id' => 'academicyeardescription')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('academicYearCode', set_value('academicyearcode') , array('class' => 'form-control', 'placeholder' => 'Academic Year Code', 'id' => 'academicyearcode')); ?>
