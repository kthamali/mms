<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Create New Level <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('levelDescription', set_value('leveldescription') , array('class' => 'form-control', 'placeholder' => 'Level Description', 'id' => 'leveldescription')); ?>
			<div class="text-error"><?php echo form_error('levelDescription'); ?></div>
		</div>

		<div class="form-group">
			<label for="constant">Constant  <span class="text-red">*</span></label>
			<?php echo form_input('constant', set_value('constant') , array('class' => 'form-control', 'placeholder' => 'Constant', 'id' => 'constant')); ?>
