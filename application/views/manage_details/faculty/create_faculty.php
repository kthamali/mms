<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Create New Faculty <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('facultyName', set_value('facultyname') , array('class' => 'form-control', 'placeholder' => 'Faculty Name', 'id' => 'facultyname')); ?>
