<div class="row">
	<div class="col-lg-12">
		<h2 class="page-header">
			...
			<?php endif ?>
			Update Permission <small class="sub-header-custom">MMS - University of Moratuwa</small>
		</h2>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?php echo form_input('permissionDescription', set_value('permissiondescription',$permission_details->permissionDescription) , array('class' => 'form-control', 'placeholder' => 'Permission Description', 'id' => 'permissiondescription')); ?>
		...
		<div class="form-group">
			...
			<?php echo form_input('code', set_value('code',$permission_details->code) , array('class' => 'form-control', 'placeholder' => 'Code', 'id' => 'code')); ?>
